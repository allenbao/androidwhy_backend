package com.androidwhy.examples.showcase.demos.mail;
...
import com.androidwhy.examples.showcase.demos.utilities.email.MimeMailService;
import com.androidwhy.examples.showcase.demos.utilities.email.SimpleMailService;
...
public class MailServiceTest extends SpringContextTestCase {
	...
	public void sendSimpleMail() throws MessagingException, InterruptedException, IOException {
		simpleMailService.sendNotificationMail("Gordon");
		...
		assertEquals("androidwhy.demo@gmail.com", message.getFrom()[0].toString());
	...
	public void sendMimeMail() throws InterruptedException, MessagingException, IOException {
		mimeMailService.sendNotificationMail("Gordon");
		...
		assertTrue(mainPartText.contains("<h1>用户Gordon被修改.</h1>"));
