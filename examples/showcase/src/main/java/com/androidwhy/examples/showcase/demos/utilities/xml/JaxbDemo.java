package com.androidwhy.examples.showcase.demos.utilities.xml;
...
import com.androidwhy.modules.mapper.JaxbMapper;
...
public class JaxbDemo {
	...
	private static String generateXmlByDom4j() {
		...
		root.addElement("name").setText("Gordon");
