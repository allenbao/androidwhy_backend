package com.androidwhy.examples.showcase.demos.utilities.email;
...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setTo("androidwhy.demo@gmail.com");
			helper.setFrom("androidwhy.demo@gmail.com");
			...
			mailSender.send(msg);
			logger.info("HTML版邮件已发送至androidwhy.demo@gmail.com");
