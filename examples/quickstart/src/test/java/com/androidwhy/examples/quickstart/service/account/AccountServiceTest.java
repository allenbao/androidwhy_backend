package com.androidwhy.examples.quickstart.service.account;

import com.androidwhy.examples.quickstart.data.UserData;
import com.androidwhy.examples.quickstart.entity.User;
import com.androidwhy.examples.quickstart.repository.TaskDao;
import com.androidwhy.examples.quickstart.repository.UserDao;
import com.androidwhy.examples.quickstart.service.ServiceException;
...
public class AccountServiceTest {
	...
	public void registerUser() {
		...
		accountService.setDateProvider(new DateProvider.ConfigurableDateProvider(currentTime));
