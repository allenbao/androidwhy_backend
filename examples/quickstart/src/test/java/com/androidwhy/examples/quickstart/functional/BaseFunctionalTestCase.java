package com.androidwhy.examples.quickstart.functional;

import com.androidwhy.modules.test.data.DataFixtures;
import com.androidwhy.modules.test.jetty.JettyFactory;
import com.androidwhy.modules.test.selenium.Selenium2;
import com.androidwhy.modules.utils.PropertiesLoader;
...
public class BaseFunctionalTestCase {
	...
	public static void beforeClass() throws Exception {
		...
		baseUrl = propertiesLoader.getProperty("baseUrl", StartServer.BASE_URL);
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), StartServer.CONTEXT);
			JettyFactory.setTldJarNames(jettyServer, StartServer.TLD_JAR_NAMES);
			jettyServer.start();
