...
<meta name="description" content="Androidwhy">
<meta name="author" content="Gordon.Huang">
                ...
                <form class="form-horizontal" action="${ctx}/login" method="post">
                    <fieldset>
                        ...
                        <div class="input-prepend">
                            <label class="remember" for="rememberMe"><input type="checkbox" id="rememberMe" name="rememberMe"/> 记住我</label>
                        </div>
                        <div class="clearfix"></div>
