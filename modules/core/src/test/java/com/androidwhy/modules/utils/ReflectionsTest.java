package com.androidwhy.modules.utils;
...
public class ReflectionsTest {
	...
	public void invokeMethod() {
		TestBean bean = new TestBean();
		//使用函数名+参数类型的匹配
		assertEquals("hello Gordon", Reflections.invokeMethod(bean, "privateMethod", new Class[] { String.class },
				new Object[] { "Gordon" }));

		//仅匹配函数名
		assertEquals("hello Gordon", Reflections.invokeMethodByName(bean, "privateMethod", new Object[] { "Gordon" }));

		//函数名错
		try {
			Reflections.invokeMethod(bean, "notExistMethod", new Class[] { String.class }, new Object[] { "Gordon" });
			fail("should throw exception here");
		} catch (IllegalArgumentException e) {
		...
		//参数类型错
		try {
			Reflections.invokeMethod(bean, "privateMethod", new Class[] { Integer.class }, new Object[] { "Gordon" });
			fail("should throw exception here");
		...
		//函数名错
		try {
			Reflections.invokeMethodByName(bean, "notExistMethod", new Object[] { "Gordon" });
			fail("should throw exception here");
		} catch (IllegalArgumentException e) {
